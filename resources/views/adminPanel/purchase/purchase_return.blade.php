            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="text-sm-end">
                                    <a href="{{ route('purchase.return.list') }}" type="button"
                                        class="btn btn-warning">Purchase Return
                                        list</a>
                                </div>
                            </div><!-- end col-->
                        </div>
                        ...
                        <div class="form">
                            <form id="purchaseForm" action="{{ route('purchase.return.save') }}" method="post">
                                @csrf
                        ...
                        @section('scripts')
                            ...
                            <script>
                                function addToCart(productId) {
                                    let url = "{{ url('purchase/fetch-product-details') }}/" + productId;
                                    ...
                                    $.ajax({
                                        url: url, // Dynamically add the product ID to the URL
                    ...
                    <tr>
                        ...
                        <td class="col d-none"><input type="number"  name="pro_id[]" value="${product.id}" readonly style="outline: none; border: none; background: transparent; pointer-events: none;" /></td>
                        <td class="col-4"><input type="text" name="pro_name[]" value="${product.name}" readonly style="outline: none; border: none; background: transparent; pointer-events: none;" /></td>
                        ...
                        <td><input type="number" name="cost_price[]" id="cost_price_${product.id}" step="0.01" value="${product.cost_price}" class="form-control" oninput="calculateTotal(${product.id})" style="outline: none; box-shadow: none; opacity: 0.9;" /></td>
                        <td><input type="number" name="qty[]" id="quantity_${product.id}" value="" step="0.01" class="form-control" oninput="calculateTotal(${product.id})" style="outline: none; box-shadow: none; opacity: 0.9;" required /></td>
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(data) {
                                                    if (data.length > 0) {
                                                        ...
                                                        selectProduct(product.id, product.code, product.product_variant_name);
                                                    }
                                                },
                                                error: function(xhr, status, error) {
