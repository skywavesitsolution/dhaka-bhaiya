                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                    ...
                                    <li class="nav-item">
                                        <a href="#date_wise_recv" data-bs-toggle="tab" aria-expanded="false"
                                    ...
                                    <li class="nav-item">
                                        <a href="#date_wise_recv_pay" data-bs-toggle="tab" aria-expanded="false"
                                            class="nav-link rounded-0">
                                            <i class="mdi mdi-home-variant d-md-none d-block"></i>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="date_wise_pay">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('date-wise-payment') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-md-5">
                                    ...
                                    <div class="tab-pane " id="cash_ledeger">

                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5>Party Wise Payable & Receivable</h5>
                                            </div>
                                            <div class="col-md-12">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="particularType" class="form-control"
                                                                    ...
                                                                    <option value="Supplier" party-type="Supplier">
                                                                        Supplier</option>
                                    ...
                                    <div class="tab-pane" id="date_wise_recv">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('date-wise-recveive-payments') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-md-5">
                                    ...
                                    <div class="tab-pane" id="date_wise_recv_pay">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="{{ URL::to('payable-receivable') }}" target="blank"
...
@section('scripts')
    ...
    <script>
        ...
        function fetchParticulars(particularType, typeId) {
            ...
            $('#' + typeId).html('<option value="Select all">Select All</option>');
            var particularsList = `<option value="Select all">Select All</option>`;
