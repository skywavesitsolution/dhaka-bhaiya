                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="cash_ledeger">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('print-cash-account-ledeger') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-md-10">
                                    ...
                                    <div class="tab-pane" id="date_wise_cash_ledeger">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('date-wise-cash-account-ledeger') }}"
                                    ...
                                    <div class="tab-pane" id="agent_ledeger">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('print-party-ledeger') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-sm-3">
                                    ...
                                    <div class="tab-pane" id="date_wise_agent_ledeger">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('date-wise-party-ledeger') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-sm-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="particular" class="form-control"
                                                                    ...
                                                                    <option value="">Chose One</option>
                                                                    <option value="Party" party-type="Marka">Supplier
                                                                    </option>
                                                                    <!-- <option value="Party" party-type="Driver">Driver</option> -->
                                                                    <option value="Party" party-type="Customer">Customer
                                                                    </option>
                                    ...
                                    <div class="tab-pane" id="supplier_customer_list">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('supplier-customer-list-print') }}"
                                                    target="blank" method="post">
                                                    @csrf
                                                    <div class="row mt-3">
    ...
    <script>
        ...
        function fetchParticulars(particularType, typeId) {
            ...
            if (type === 'Party') {
                ...
                // Loop through parties to filter and add options based on party type
                parties.forEach((party) => {
                    ...
                    if (partyType === 'Customer' && party['type'] === 'Customer') {
                        ...
                        // Show/hide sections based on 'particularType'
                        if (particularType === 'particular') {
                            $('#supplier-div-payment').css('display', 'block');
                            $('#supplier-div-datewise').css('display', 'none');
                        } else {
                ...
                // Hide sections for types other than 'Customer'
                if (partyType == 'Customer') {
                    $('#supplier-div-payment').css('display', 'none');
                    $('#supplier-div-datewise').css('display', 'none');
                }
            ...
            // Populate the dropdown and initialize select2
            $('#' + typeId).html(particularsList);
            $('#' + typeId).select2();
        }
