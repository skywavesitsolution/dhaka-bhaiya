        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Customer Receivable</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                    ...
                                    @isset($getSaleInvoice)
                                        @foreach ($getSaleInvoice as $saleInvoice)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $saleInvoice->party->name ?? 'null' }}
                                                </td>
                                                <td>
                                                    {{ $saleInvoice->party->type ?? 'null' }}
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    {{ $saleInvoice->bilty->bilty_number ?? 'null' }}
                                                </td>
                                                <td class="table-action">
                                                    <a href='{{ URL::to("sale-product-print/{$saleInvoice->id}") }}'
