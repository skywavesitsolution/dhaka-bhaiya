        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Payments Alerts</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-7">
                                <div class="text-sm-end">
                                    {{-- <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#standard-modal"> --}}
                                            ...
                                            @foreach ($purchases as $purchase)
                                                <tr>
                                                    ...
                                                    <td class="table-action">
                                                        {{-- <a href="{{route('purchase.getPurchase', $purchase->id)}}"><i class="mdi mdi-square-edit-outline"></i></a>                --}}
                                                        <a href="{{ route('purchase.print', $purchase->id) }}"
                                                            class="btn btn-warning" target="_blank"><i class="fas fa-print"></i>
                                                        </a>
                                                        <a href='{{ URL::to("purchase/delete-purchase-invoice/{$purchase->id}") }}'
                                                            class="btn btn-warning btn-sm action-icon text-white"> <i
