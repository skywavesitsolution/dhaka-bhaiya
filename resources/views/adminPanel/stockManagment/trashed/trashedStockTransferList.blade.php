            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-5">
                                <h4 class="page-title">Trashed Transfer Stock List</h4>
                            </div>
                            <div class="col-sm-7">
                                        ...
                                        @foreach ($stockTransfers as $stockTransfer)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{-- <a href="{{ route('stock-transfer.print.details', $stockTransfer->id) }}" target="_blank" class="action-icon text-warning">
                                                    <i class="mdi mdi-printer"></i>
                                                </a> --}}
                                                    {{-- <a href="javascript:void(0)" class="action-icon text-danger stock-transfer-del-btn"  data-id="{{ $stockTransfer->id }}"><i class="mdi mdi-delete"></i></a> --}}
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endisset
