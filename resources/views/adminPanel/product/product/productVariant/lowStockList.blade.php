        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="page-title-box">
                    ...
                    {{-- <h4 class="page-title">Variant Low Stock</h4> --}}
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-5">
                                <h4 class="page-title">Product Low Stock List</h4>
                            </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            let savedColumns = JSON.parse(localStorage.getItem('productLowStockTaleColumnSettings')) || [0, 1, 2, 3,
                5, 6
            ];
            ...
            $('.column-checkbox').on('change', function() {
                ...
                localStorage.setItem('productLowStockTaleColumnSettings', JSON.stringify(savedColumns));
            });
        });
    </script>
@endsection
