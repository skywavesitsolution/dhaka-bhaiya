                            ...
                            <div class="col-md-12">
                                <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                    ...
                                    <li class="nav-item d-none">
                                        <a href="#last_transcation" data-bs-toggle="tab" aria-expanded="true"
                                            class="nav-link rounded-0">
                                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                    ...
                                    <li class="nav-item d-none">
                                        <a href="#sup_customer_last_transcation" data-bs-toggle="tab" aria-expanded="true"
                                            class="nav-link rounded-0">
                                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane show active" id="cash_ledeger">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <form action="{{ URL::to('party-wise-balance-list') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-sm-3">
                                                            <div class="mb-3">
                                                                <label for="example-input-normal" class="form-label">Select
                                                                    Particular</label>
                                                                <select name="particularType" class="form-control"
                                                                    onchange="fetchParticulars('particular','particularId')"
                                                                    id="particular">
                                                                    <option value="">Chose One</option>
                                                                    <option value="Supplier" party-type="Supplier">Supplier
                                                                    </option>
                                                                    <option value="Customer" party-type="Customer">Customer
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="tab-pane" id="supplier_customer_list">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <a href="{{ URL::to('all-customer-balance-list') }}"
                                    ...
                                    <div class="tab-pane" id="last_transcation">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('party-last-transcation') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-sm-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="particular" class="form-control">
                                                                    <option value="">Chose One</option>
                                                                    <option value="Supplier" party-type="Marka">Supplier
                                                                    </option>
                                                                    {{-- <option value="Driver" party-type="Driver">Driver</option> --}}
                                                                    <option value="Customer" party-type="Customer">
                                                                        Customer</option>
                                                                </select>
                                    ...
                                    <div class="tab-pane d-none" id="sup_customer_last_transcation">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('supplier-customer-last-transcation') }}"
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-sm-3" id="supplier-div-payment">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name=""
                                                                    onchange="fetchSupplierCustomers('supplier_id_last','particularId')"
                                                                    class="form-control select2" id="supplier_id_last">
                                                                    <option value="-1">Select One</option>
                                                                    @isset($suppliers)
                                                                        @foreach ($suppliers as $supplier)
