            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ URL::to('order-update/' . $order->id . '') }}" method="post">
                            @csrf
                                ...
                                <div class="row mb-2">
                                                    ...
                                                    @foreach ($parties as $party)
                                                        @if ($party->type == 'Marka')
                                                            <option value="{{ $party->id }}"
                                                                @if ($order->marka_id == $party->id) selected @endif>
                                                                {{ $party->name }}</option>
                                                        @endif
                                                    @endforeach
                                                @endisset
                                                ...
                                                @isset($productTypes)
                                                    @foreach ($productTypes as $productType)
                                                        <option value="{{ $productType->id }}"
                                                            @if ($order->product_type == $productType->id) selected @endif>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step=".02" name="purchaseQty"
                                                value="{{ $order->purchase_qty }}" id="purchaseQty"
                                                class="form-control calculateTotalAmount" required>
                                            @error('purchaseQty')
                                                <p class="text-danger mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="purRate" value="{{ $order->purchase_rate }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="totalAmount" value="{{ $order->total_purchase }}"
                                                ...
                                                @isset($parties)
                                                    @foreach ($parties as $party)
                                                        @if ($party->type == 'Driver')
                                                            <option value="{{ $party->id }}"
                                                                @if ($order->driver_id == $party->id) selected @endif>
                                                                {{ $party->name }}</option>
                                                        @endif
                                                    @endforeach
                                                @endisset
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="carAmount" value="{{ $order->carriage_amount }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="totalCarriage"
                                                value="{{ $order->total_carriage }}" id="totalCarriage" readonly
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="grandTotal"
                                                value="{{ $order->grand_purchase_amount }}" id="grandTotal"
                                                class="form-control" readonly required>
                                            @error('grandTotal')
                                                <p class="text-danger mt-2">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="customer" id="customer-id" class="form-control" required>
                                                ...
                                                @isset($parties)
                                                    @foreach ($parties as $party)
                                                        @if ($party->type == 'Customer' && $party->supplier_id == $order->supplier_id)
                                                            <option value="{{ $party->id }}"
                                                                @if ($order->customer_id == $party->id) selected @endif>
                                                                {{ $party->name }}</option>
                                                        @endif
                                                    @endforeach
                                                @endisset
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="saleRate" value="{{ $order->sale_rate }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="saleAmount"
                                                value="{{ $order->total_sale_amount }}" id="totalSaleAmount"
                                                class="form-control" readonly required>
                                            @error('saleAmount')
                                                <p class="text-danger mt-2">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="profit" value="{{ $order->profit }}"
                                                id="profit" class="form-control" readonly required>
                                            @error('profit')
                                                <p class="text-danger mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
