...
@if($request->product_id == 'all_products')
    <h3 style="margin-top:40px;">All Products Sale Summary</h3>
@else
    @php
        $product = App\Models\Product\Product::find($request->product_id);
    @endphp
    <h3 style="margin-top:40px;">{{ $product ? $product->product_name : 'Unknown Product' }} Sale Summary</h3>
@endif
...
<section style="margin: 20px;">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{-- <table class="table table-sm table-hover table-bordered" style="border: 2px solid black; width:25%;">
                <thead style="color: black; border: 1px solid black;">
                    <tr>
