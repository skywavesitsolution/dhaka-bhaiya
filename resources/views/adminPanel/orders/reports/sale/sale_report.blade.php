            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-5">
                                <h4 class="page-title">Product Sale Reports</h4>
                            </div>
                            <div class="col-sm-7">
                            </div><!-- end col-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                    <li class="nav-item">
                                        <a href="#product_date_sale_report" data-bs-toggle="tab" aria-expanded="true"
                                            class="nav-link rounded-0 active">
                                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                            <span class="d-none d-md-block">Date wise Sale Report</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#product_sale_report" data-bs-toggle="tab" aria-expanded="true"
                                            ...
                                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                            <span class="d-none d-md-block">Product wise Sale Report</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    {{-- <li class="nav-item">
                                        <a href="#brand_wise_sale_report" data-bs-toggle="tab" aria-expanded="false"
                                            class="nav-link rounded-0">
                                            <i class="mdi mdi-home-variant d-md-none d-block"></i>
                                            <span class="d-none d-md-block">Brand wise Sale Report</span>
                                        </a>
                                    </li> --}}
                                    ...
                                    {{-- <li class="nav-item">
                                        <a href="#customer_wise_sale_report" data-bs-toggle="tab" aria-expanded="false"
                                            ...
                                            <span class="d-none d-md-block">Customer wise Sale Report</span>
                                        </a>
                                    </li> --}}
                                    <li class="nav-item">
                                        <a href="#category_wise_sale_report" data-bs-toggle="tab" aria-expanded="false"
                                            class="nav-link rounded-0">
                                            <i class="mdi mdi-settings-outline d-md-none d-block"></i>
                                            <span class="d-none d-md-block">Category wise Sale Report</span>
                                        </a>
                                    </li>
                                    {{-- <li class="nav-item">
                                    ...
                                    {{-- <li class="nav-item">
                                        <a href="#profit_margin" data-bs-toggle="tab" aria-expanded="false"
                                            class="nav-link rounded-0">
                                            <i class="mdi mdi-settings-outline d-md-none d-block"></i>
                                            <span class="d-none d-md-block">Profit Margin</span>
                                        </a>
                                    </li> --}}
                                </ul>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="product_sale_report">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('all_product_sale_report') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-md-3">
                                                                ...
                                                                @isset($allProducts)
                                                                    @foreach ($allProducts as $allProduct)
                                                                        <option value="{{ $allProduct->id }}">
                                                                            {{ $allProduct->product_variant_name }}
                                                                            ({{ $allProduct->service_item ? 'Service Item' : ($allProduct->raw_material ? 'Ingredient' : 'Finished Good') }})
                                                                        </option>
                                                                    @endforeach
                                                                @endisset
                                                            </select>
                                    ...
                                    <div class="tab-pane show active" id="product_date_sale_report">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5>Date Wise Sale Summary</h5>
                                            </div>
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('date_product_sale_report') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                    ...
                                    <div class="tab-pane" id="invoice_profit_report">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('invoice_wise_profit_margin') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        {{-- <div class="col-md-3">
                                    ...
                                    <div class="tab-pane" id="date_wise_sale_summary">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('date_wise_product_sale_summary') }}"
                                    ...
                                    <div class="tab-pane" id="brand_wise_sale_report">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5>Brand wise Sale Report</h5>
                                            </div>
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('brand_wise_product_sale_report') }}"
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-3">
                                                            ...
                                                            <select name="brand_id" class="form-control select2"
                                                                data-toggle="select2">
                                                                <option value="all_brands" selected>All Brands</option>
                                    ...
                                    <div class="tab-pane" id="customer_wise_sale_report">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5>Customer wise Sale</h5>
                                            </div>
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('customer_wise_product_sale_report') }}"
                                                    target="blank" method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-md-3">
                                                            ...
                                                            <select name="customer_id" class="form-control select2"
                                                                data-toggle="select2">
                                                                <option value="all_customers" selected>All Customer
                                                                </option>
                                    ...
                                    <div class="tab-pane" id="category_wise_sale_report">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('category_wise_product_sale_report') }}"
                                                    target="blank" method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-md-3">
                                    ...
                                    <div class="tab-pane" id="location_wise_sale_report">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5>Location wise Sale</h5>
                                            </div>
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('location_wise_product_sale_report') }}"
                                                    target="blank" method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-md-3">
                                    ...
                                    <div class="tab-pane" id="employee_wise_sale_report">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5>Employee wise Sale</h5>
                                            </div>
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('employee_wise_product_sale_report') }}"
                                                    target="blank" method="post">
                                                    @csrf
                                                    <div class="row mt-3">
                                                        <div class="col-md-3">
                                                            ...
                                                            <select name="employee_id" class="form-control select2"
                                                                data-toggle="select2">
                                                                <option value="all_employee" selected>All Employee</option>
                                    ...
                                    {{-- <div class="tab-pane" id="profit_margin">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5>Profit Margin</h5>
                                            </div>
                                            <div class="col-md-12">
                                                <form action="{{ URL::to('date_wise_profit_margin') }}" target="blank"
                                                    method="post">
                                                    @csrf
                                                    <div class="row mt-3">
