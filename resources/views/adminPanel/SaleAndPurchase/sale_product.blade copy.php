...
<style>
    ...
    .table-centered {
        table-layout: fixed;
        /* Optional: Ensures table cells have a consistent width */
    }

    #tableBody {
        display: block;
        /* This makes the table body scrollable */
        max-height: 65vh;
        /* Set a fixed height for the body of the table */
        /* overflow-y: auto; */
        /* Enables vertical scrolling */
        overflow-x: hidden;
        /* Hides horizontal scrolling if not needed */
    }
    ...
    thead {
        display: table;
        /* Ensures the header stays at the top when scrolling */
        width: 100%;
    }
    ...
    .table-responsive {
        max-height: 100%;
        /* Ensure the table takes up the available space within the card body */
    }
    ...
    .custom-item {
        /* flex: 0 0 12.5%; */
        /* 1.5 out of 12 columns in Bootstrap (1.5/12 = 12.5%) */
        /* max-width: 200px; */
        max-width: 80px;
    ...
    <script>
        ...
        function toggleReturnMode() {
            ...
            $.toast({
                ...
                text: isReturnMode ?
                    "Newly added product quantities will now be saved as negative values." : "Quantities will now be saved as positive values.",
                icon: 'success',
                loader: true,
                loaderBg: '#007bff',
                position: "top-right",
                        ...
                        success: function(data) {
                            ...
                            $.ajax({
                                ...
                                success: function(discountData) {
                                    ...
                                    $('#tableBody').append(hiddenRowHTML);
        ...
        $(document).ready(function() {
            ...
            $('#bestSellingBtn').click(function(event) {
                ...
                if (isFilterApplied) {
                    ...
                    $.ajax({
                        url: '{{ URL::to('
                        best - selling - products ') }}', // Adjust URL if needed
                        type: 'GET',
                        success: function(data) {
